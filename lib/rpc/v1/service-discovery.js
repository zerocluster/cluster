    ...
    class extends Super {
        ...
        async [ "API_register-service" ] ( ctx, { appName, serviceName, port } ) {
            ...
            if ( !connectionData.ports[ port ] ) {
                ...
                this.app.publishToRpc( `service-discovery/add-service/${ appName }/${ serviceName }`, eventData );
            }
        ...
        async [ "API_unregister-service" ] ( ctx, { port } ) {
            ...
            this.app.publishToRpc( `service-discovery/delete-service/${ connectionData.appName }/${ portData.serviceName }`, eventData );

            return result( 200 );
        }

        async [ "API_get-services" ] ( ctx, { appName, serviceName } = {} ) {
            const hosts = [];
        ...
        #onDisconnect ( connection ) {
            ...
            this.#connections.delete( connection.remoteAddress.toString() );
